        ...
        <div class="row inforation-wrapper">
          <div class="col-lg-3 col-md-6 col-xs-12">
            <ul>
              ...
              <li><span><b>Location</b> Gopher Hall, Lagos, Nigeria</span></li>
            </ul>
          </div>
          <div class="col-lg-3 col-md-6 col-xs-12">
            <ul>
            ...
            <div class="about-content">
              <div>
                ...
                <ul class="stylish-list mb-3">
                  ...
                  <li><i class="lni-check-mark-circle"></i>Meet New Professional Gophers</li>
                  <li><i class="lni-check-mark-circle"></i>Get Inspired by Amazing Speakers</li>
                  <li><i class="lni-check-mark-circle"></i>Explore the Beauty of Lagos</li>
                </ul>
        ...
        <div class="row justify-content-bt">
          <div class="col-lg-3 col-md-6 col-xs-12">
            ...
            <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
              <div class="team-img">
                <img class="img-fluid" src="../assets/img/golang.png" alt="">
        ...
        <div class="row mb-30 text-center wow fadeInDown" data-wow-delay="0.3s">
          <div class="col-lg-12">
            <div class="sponsors-logo text-center">
               <a href=""><img src="../assets/img/go.png" alt=""></a>
               <a href=""><img src="../assets/img/go.png" alt=""></a>
               <a href=""><img src="../assets/img/go.png" alt=""></a>
               <a href=""><img src="../assets/img/go.png" alt=""></a>
               <a href=""><img src="../assets/img/go.png" alt=""></a>
        ...
        <div class="row contact-wrapper">
          <div class="col-lg-4 col-md-5 col-xs-12">
            <ul>
              ...
              <li><span>20a, Gophercon Building. Lagos, Nigeria </span></li>
            </ul>
          </div>
          ...
          <div class="col-lg-4 col-md-3 col-xs-12">
            <ul>
              ...
              <li><span>gopherconafrica@nectarhub.io</span></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-12 col-xs-12">
            ...
            <div class="site-info">
              <p>Designed and Developed by <a href="#" rel="nofollow">GopherConAfrica</a></p>
            </div>
          </div>
        </div>
      </div>
